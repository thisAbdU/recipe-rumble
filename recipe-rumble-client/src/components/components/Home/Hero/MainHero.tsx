    ...
    <div className='py-40'>
      <div className='flex flex-col md:flex-row gap-y-10 justify-between items-center w-[70%] mx-auto'>
        <div className="flex flex-col items-start gap-8 ">
            <TypeWriterComponent/>
            <div className="flex items-center border rounded-full overflow-hidden p-1 bg-orange-200">
                <input
                    type="text"
                    placeholder="Search for recipes, challenges, or food items"
                    className="flex-grow px-2 md:px-4 py-1 md:py-2 bg-transparent focus:outline-none"
                />
                <button className="px-3">
                    <CiSearch className="text-orange-600" size={20} />
                </button>
            </div>
        </div>
